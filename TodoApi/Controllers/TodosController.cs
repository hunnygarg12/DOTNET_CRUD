...
namespace TodoApi.Controllers
{
    ...
    public class TodosController : ControllerBase
    {
        ...
        public async Task<ActionResult<List<TodoModel>>> Get()
        {
            ...
            {
                _logger.LogError(ex, message: "The Get Call to api failed.");
                return BadRequest();
            }
        }
        ...
        public async Task<ActionResult<TodoModel>> Post([FromBody] string task)
        {
            ...
            catch (Exception ex)
            {
                ...
                _logger.LogError(ex, message: "The POST Call to api failed. Task value was {Task}", task);
                return BadRequest();
            }
        }
        ...
        {
            _logger.LogInformation(message: "POST: api/Todos/{TodoId} (Task: {Task})",todoId, task);
            ...
            catch (Exception ex)
            {
                ...
                _logger.LogError(
                    ex,
                    message: "The PUT Call to api/Todos/{TodoId} failed. Task value was {Task}",
                    todoId,
                    task);
                return BadRequest();
            }
        ...
        {
            _logger.LogInformation(message: "POST: api/Todos/{TodoId}/Complete", todoId);
